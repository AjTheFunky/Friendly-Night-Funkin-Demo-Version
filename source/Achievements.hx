...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["Friendly on a Friday Night",	"Play on a Friday... Night.",						'friday_night_play',	 true],
		["Outsmart the Scientist",		"Beat Week 1 on Hard with no Misses.",				'week1_nomiss',			false],
		["Haunted House!?",				"Beat Week 2 on Hard with no Misses.",				'week2_nomiss',			false],
		["Left No Crumbs On Your Plate",			"Beat Week 3 on Hard with no Misses.",				'week3_nomiss',			false],
		...
		["You'll get it eventually...",	"Complete a Song with a rating lower than 20%.",	'ur_bad',				false],
		...
		["Verbalexi Beatbox",					"Beat the \"Tetris\" Song from the Chart Editor.",	'debugger',				 true]
	];
